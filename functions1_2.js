const orden = [
    { dispositivo: "127.191.193.0/24", respuesta: "255.255.255.0", ayuda: "La Clase A tiene un rango de:<br> 0.0.0.0 a 127.255.255.255" },
    { dispositivo: "129.86.0.0/7", respuesta: "254.0.0.0", ayuda: "La Clase B tiene un rango de:<br> 128.0.0.0 a 191.255.255.255" },
    { dispositivo: "193.191.0.1/16", respuesta: "255.255.0.0", ayuda: "La Clase C tiene un rango de:<br> 192.0.0.0 a 223.255.255.255" },
];
...
function siguienteNivel() {
    ...
    window.location.href = "information1_3.html";
}
